...
public class Tools {
    ...
    public static void displayImageAjustado(Context ctx, ImageView img, String url) {
        try {
            Glide.with(ctx).load(url).override(400, 250)
                    .crossFade()
    ...
    public static void displayImageIcon(Context ctx, ImageView img, String url){
        Glide.with(ctx)
                .load(url)
