...
import org.activity.promofire.fragment.FragmentNormalMain;
import org.activity.promofire.fragment.FragmentPremiumMain;
...
public class ActivityMain extends AppCompatActivity {
    ...
    private void initFragment() {
        ...
        FragmentPremiumMain fragmentPremiumMain = new FragmentPremiumMain();
        fragmentTransaction.replace(R.id.frame_content_premium, fragmentPremiumMain);

        Bundle arguments = new Bundle();
        arguments.putInt("categoria", 1);

        FragmentNormalMain fragmentNormalMain = FragmentNormalMain.newInstance(arguments);
        fragmentTransaction.replace(R.id.frame_content_categoria, fragmentNormalMain);

        arguments = new Bundle();
        arguments.putInt("categoria", 2);

        FragmentNormalMain fragmentNormalMain2 = FragmentNormalMain.newInstance(arguments);
        fragmentTransaction.replace(R.id.frame_content_categoria2, fragmentNormalMain2);

        arguments = new Bundle();
        arguments.putInt("categoria", 3);

        FragmentNormalMain fragmentNormalMain3 = FragmentNormalMain.newInstance(arguments);
        fragmentTransaction.replace(R.id.frame_content_categoria3, fragmentNormalMain3);
...
*/
    ...
    public boolean onItemSelected(int id) {
        ...
        switch (id) {
            ...
            case R.id.nav_categoria:
                i = new Intent(this, ActivityCategorias.class);
                startActivity(i);
                break;
    ...
    */
    ...
    private void updateNavCounter(NavigationView nav) {
        ...
        //((TextView) menu.findItem(R.id.nav_categoria).getActionView().findViewById(R.id.counter)).setText(String.valueOf(cart_count));
        ((TextView) menu.findItem(R.id.nav_categoria).getActionView().findViewById(R.id.counter)).setVisibility(View.GONE);

        ((TextView) menu.findItem(R.id.nav_recomendaciones).getActionView().findViewById(R.id.counter)).setVisibility(View.GONE);

        ((TextView) menu.findItem(R.id.nav_promo_categoria).getActionView().findViewById(R.id.counter)).setVisibility(View.GONE);

        ((TextView) menu.findItem(R.id.nav_promo_valoracion).getActionView().findViewById(R.id.counter)).setVisibility(View.GONE);

        ((TextView) menu.findItem(R.id.nav_promo_fecha).getActionView().findViewById(R.id.counter)).setVisibility(View.GONE);
