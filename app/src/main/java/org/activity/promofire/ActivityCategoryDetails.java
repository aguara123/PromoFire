...
import org.activity.promofire.adapter.AdapterProduct;
...
import org.activity.promofire.entity.Product;
...
public class ActivityCategoryDetails extends AppCompatActivity {
    ...
    // activity transition
    public static void navigate(Activity activity, Categoria obj) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category = (Categoria) getIntent().getSerializableExtra(EXTRA_OBJECT);
        initComponent();
        initToolbar();
    ...
    private void displayCategoryData(Categoria c) {
        ((AppBarLayout) findViewById(R.id.app_bar_layout)).setBackgroundColor(Color.parseColor("green"));
        ((TextView) findViewById(R.id.name)).setText(c.categoria);
        ((TextView) findViewById(R.id.brief)).setText(c.categoria);
        ImageView icon = (ImageView) findViewById(R.id.icon);
        Tools.displayImageOriginal(this, icon, c.urlPhoto);
        Tools.setSystemBarColorDarker(this, "green");
    ...
    private void requestListProduct(final int page_no) {
        ...
        callbackCall = api.getListProduct(page_no, Constant.PRODUCT_PER_REQUEST, null, category.idCategoria);
