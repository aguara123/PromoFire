...
import org.activity.promofire.ActivityPromocionesDetalle;
...
public class FragmentPremiumMain extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        root_view = inflater.inflate(R.layout.fragment_premium, null);
        initComponent();
        //requestFeaturedNews();
    ...
    private void displayResultData(List<Servicio> items) {
        ...
        adapter.setOnItemClickListener(new AdapterServiciosSlider.OnItemClickListener() {
            ...
            public void onItemClick(View view, Servicio obj) {
                ...
                ActivityPromocionesDetalle.navigate(getActivity(), obj.idServicio, false);
            }
        });
